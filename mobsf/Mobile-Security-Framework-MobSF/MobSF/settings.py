...
if CONFIG_HOME:
    ...
    APKTOOL_BINARY = ""
    ADB_BINARY = r"/Users/dass/Library/Android/Sdk/platform-tools/adb"
    ENJARIFY_DIRECTORY = ""
    ...
    AVD_EMULATOR = r"/Users/dass/Library/Android/Sdk/emulator/emulator"
    AVD_PATH = r"/Users/dass/.android/avd"
    ...
    # VM UUID
    UUID = 'ab405d0c-496f-4e0d-8ff1-6a541d362a75'
    # Snapshot UUID
    SUUID = '905c2d46-5460-41ab-99ac-ed360deaf123'
    # IP of the MobSF VM
    ...
    #================HOST/PROXY SETTINGS ===============
    PROXY_IP = '192.168.56.2'  # Host/Server/Proxy IP
